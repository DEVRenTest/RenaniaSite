...
$_['entry_max_delay']           = 'Max delay (days): <span class="help">number of max days after cart is considered inactive and can be sent an reminder</span>';
...
$_['error_max_delay']           = 'Max delay - required';
