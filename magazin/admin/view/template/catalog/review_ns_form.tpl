  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">		  <tr>            <td><span class="required">*</span> <?php echo "Titlu"; ?></td>            <td><input size="64" type="text" name="title" value="<?php echo $title; ?>" />              <?php if ($error_author) { ?>              <span class="error"><?php echo $error_title; ?></span>              <?php } ?></td>          </tr>
          <tr>
            <td><span class="required">*</span> <?php echo $entry_author; ?></td>
            <td><input size="64" type="text" name="author" value="<?php echo $author; ?>" />
              <?php if ($error_author) { ?>
          ...
          <tr>
            ...
            <td><input size="64" type="text" name="product" value="<?php echo $product; ?>" />
          ...
          <tr>
            ...
            <td><select name="status">
                <?php if ($status) { ?>
                <option value="1" selected="selected"><?php echo "Da"; ?></option>
                <option value="0"><?php echo "Nu"; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo "Da"; ?></option>
                <option value="0" selected="selected"><?php echo "Nu"; ?></option>
                <?php } ?>
              </select></td>             
          </tr>		  <tr>				<td><?php echo $entry_bought; ?></td>				<td>					<select name="bought">					<?php if ($bought){ ?>													<option value="1" selected="selected">Da</option>							<option value="0">Nu</option>						<? }else{ ?>							<option value="1">Da</option>							<option value="0" selected="selected">Nu</option>						<?php } ?>					</select>				</td>          </tr>		  <tr>				<td><?php echo $entry_ip; ?></td>				<td><?php echo $ip; ?></td>          </tr>
        </table>
      </form>
    </div>
  </div>
