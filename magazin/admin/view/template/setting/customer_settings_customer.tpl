...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/setting.png" alt="" /> <?php echo $heading_title_customer; ?></h1>
    </div>
    <div class="content">
        ...
        <table class="list">
          ...
          <?php for ($i=0; $i < count($current_settings); $i++) { ?>
            <tr id="input_<?php echo $i; ?>">
              <td class="left">
                <select name="settings[<?php echo $i; ?>][store_id]" required="required">
                <?php foreach ($stores as $store) { ?>
                  <option value="<?php echo $store['id']; ?>"<?php if ($store['id'] == $current_settings[$i]['store_id']) { ?> selected="selected"<?php } ?>><?php echo $store['name']; ?></option>
                <?php } ?>
                </select>
              </td>
              <td class="left">
