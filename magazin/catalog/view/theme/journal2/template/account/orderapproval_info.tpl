...
<div id="content"><h1 class="heading-title"><?php echo $heading_title; ?></h1><?php echo $content_top; ?>
  ...
  <div class="left">
  <form method="post" id="order_approve" style="margin-right: 15px;">
     <button name="order_status" value="1" type="submit" class="button"><?php echo $button_approve; ?></button>
  </form>
  </div>
  <div class="left">
  <form method="post" id="order_deny">
     <button name="order_status" value="0" type="submit" class="button"><?php echo $button_deny; ?></button>
  </form>
  </div>
  </div>
