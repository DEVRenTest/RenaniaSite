...
class ControllerModuleAbandonedCartReminder extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_max_delay']   = $this->language->get('entry_max_delay');
		...
		if (isset($this->error['max_delay'])) {

			$this->data['error_max_delay'] = $this->error['max_delay'];

		} else {

			$this->data['error_max_delay'] = '';
		...
		if (isset($this->request->post['abandoned_cart_max_reminder_delay'])) {

			$this->data['abandoned_cart_max_reminder_delay'] = $this->request->post['abandoned_cart_max_reminder_delay'];

		} elseif ($this->config->get('abandoned_cart_max_reminder_delay')) { 

			$this->data['abandoned_cart_max_reminder_delay'] = $this->config->get('abandoned_cart_max_reminder_delay');

		} else {

			$this->data['abandoned_cart_max_reminder_delay'] = 5;
	...
	private function validate() {
		...
		if ($dinamic_strlen($this->request->post['abandoned_cart_max_reminder_delay']) < 1) {

			$this->error['max_delay'] = $this->language->get('error_max_delay');
