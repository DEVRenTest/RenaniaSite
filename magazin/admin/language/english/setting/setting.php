...
$_['entry_order_unapproved_status'] = 'Unapproved Order Status :<br /><span class="help">Order status for orders that exceed the budget allocated to customer.</span>';
$_['entry_order_customer_approved_status'] = 'Customer Approved Order Status:<br /><span class="help">Set status for orders approved by customers.</span>';
$_['entry_order_customer_refuzed_status'] = 'Customer Refused Order Status:<br /><span class="help">Set status for orders refused by customers.</span>';
