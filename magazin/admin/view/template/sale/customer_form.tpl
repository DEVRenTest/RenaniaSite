        ...
        <div id="tab-general">
          ...
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_order_limit; ?></td>
                <td><input type="number" name="order_limit" value="<?php echo ($order_limit > -1 ? $order_limit : ''); ?>" />
                    <input type="checkbox" name="order_limit" value="-1"<?php if ($order_limit == -1) { ?> checked="checked"<?php } ?>/>
                    <label for="order_limit_checkbox"><?php echo $text_unlimited; ?></label>
                  <?php if ($error_order_limit) { ?>
                  <span class="error"><?php echo $error_order_limit; ?></span>
                  <?php  } ?></td>
              </tr>
              <tr>
