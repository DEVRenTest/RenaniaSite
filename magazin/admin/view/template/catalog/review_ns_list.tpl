...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">			<a id="activare" class="button"><?php echo $button_publica; ?></a>			<a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a>			<a onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a>		</div>		
    </div>
    <div class="content">
          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>							  <td class="left"><?php echo $column_title; ?></td>			  <td class="left"><?php echo $column_opinie; ?></td>
              ...
              <td class="left"><?php if ($sort == 'r.date_added') { ?>
                ...
                <?php } ?></td>								<td class="left"><?php if ($sort == 'r.bought') { ?>                <a href="<?php echo $sort_bought; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_bought; ?></a>                <?php } else { ?>                <a href="<?php echo $sort_bought; ?>"><?php echo $column_bought; ?></a>                <?php } ?></td>								<td class="left">                <?php echo $column_ip; ?>                </td>
              <td class="right" style="min-width:52px;"><?php echo $column_action; ?></td>
            </tr>
          </thead>
          <tbody>
            <?php if ($reviews) { ?>
            ...
            <tr>
              ...
              <td class="left"><?php if ($review['status']){ ?><b style="color:green">&check;</b><? }else{ ?><b style="color:red">&cross;</b><?php } ?></td>
              <td class="left"><?php echo $review['date_added']; ?></td>			                <td class="left"><?php if ($review['bought']){ ?><b style="color:green">&check;</b><? }else{ ?><b style="color:red">&cross;</b><?php } ?></td>			                <td class="left"><?php echo $review['ip']; ?></td>
...
</div><a style="display:none" id="act_link" href="<?php echo $activare; ?>"></a><script>jQuery(document).ready(function($) {	$('#activare').click(function (e) {		e.preventDefault()		var url = $('#act_link').attr("href");		$('form').attr("action", url);		//console.log(url);		$('form').submit();	});});</script>
<?php echo $footer; ?>